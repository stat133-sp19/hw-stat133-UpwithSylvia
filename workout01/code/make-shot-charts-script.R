...
draymond_shot_chart = ggplot(data = draymond)+annotation_custom(court_images, -250, 250, -50, 420)+ geom_point(aes(x=x, y=y, color=shot_made_flag))+
...
kevin_shot_chart = ggplot(data = kevin)+annotation_custom(court_images, -250, 250, -50, 420)+ geom_point(aes(x=x, y=y, color=shot_made_flag))+
...
klay_shot_chart = ggplot(data = klay)+annotation_custom(court_images, -250, 250, -50, 420)+ geom_point(aes(x=x, y=y, color=shot_made_flag))+
...
stephen_shot_chart = ggplot(data = stephen)+annotation_custom(court_images, -250, 250, -50, 420)+ geom_point(aes(x=x, y=y, color=shot_made_flag))+
...
gsw_shot_charts = ggplot(data=shots)+annotation_custom(court_images, -250, 250, -50, 420)+ geom_point(aes(x=x, y=y, color=shot_made_flag))+
